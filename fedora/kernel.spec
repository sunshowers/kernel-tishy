...
# tishy HDMI FRL + VRR patches (see ../patches/README.md for provenance)
Patch1: 0001-fix-amd-color-manager.patch
Patch2: 0002-fix-dc-plane-cm-build-error.patch
Patch3: 0003-hdmi-frl.patch
Patch4: 0004-hdmi-vrr.patch
...
# Apply tishy HDMI FRL + VRR patches on top of the OGC base
patch -p1 -i %{PATCH1}
patch -p1 -i %{PATCH2}
patch -p1 -i %{PATCH3}
patch -p1 -i %{PATCH4}
